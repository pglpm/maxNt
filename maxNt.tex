...
%% Last-Updated: 2017-05-18T16:09:42+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
...
about all other neurons in the same brain area. That is, we assume
...
here, but stress that these sample sizes can be considered
...
apply the \me\ method to a representative  sample to find a maximally
...
sampling. These relations are well-known in survey
