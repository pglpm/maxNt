...
Recent advances in electrophysiological recordings allow to
 study the activity of large population of neurons 
in relation to stimuli and bahavioral tasks [\cite]. Huge amount of parallel
 ...
 the statistical challenges to be employed for shedding light on the mechanism behind neuronal coding. 
The principle of \me\ was proposed as a way to overcome these challenges by constructing a full description of the 
neuronal firing patterns. The \me\ method exploits only first and second
order statistics of the observed data and construct a least structured or
a \enquote{maximally noncommital} probability distribution of firing patterns [\cite].

Using the pairwise \me\ models many studies strived for answering 
 ...
 of neurons can be related to stimuli or behavioral tasks [\cite]?

Here we show that there is a
contradiction in applying \me\ to the observed data \enquote{representative random sample}
