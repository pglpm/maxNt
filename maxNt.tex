...
%% Last-Updated: 2017-05-14T12:06:05+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
...
\end{equation}
where $\yH$ denotes our state of knowledge (the evidence and assumptions
...
\begin{gather}
  ...
  \p(\yxs=\yrs \| \yH) = \binom{n}{n\yrs}
  \sum_{N \yRf =0}^{N} \binom{N-n}{N \yRf-n\yrs}\binom{N}{N \yRf}^{-1}\,
  \p(\yXf=\yRf \| \yH).
\end{gather}
The combinatorial proof is the same as for the theory of drawing without
replacement, leading to the hypergeometric distribution, and can be found
in many texts
\cites[\chap~3]{jaynes1994_r2003}[\sect~4.8.3]{ross1976_r2010}[\sect~II.6]{feller1950_r1968}.
The symmetry of our initial ignorance should intuitively also apply to the
...
Formula~\eqref{eq:subpop_average}, connecting our initial probabilities for
the population and sample averages, has a very important consequence: \emph{our
expectations for all averages of the sample and the full population are the
same}:
\begin{multline}
