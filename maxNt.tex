...
%% Last-Updated: 2017-05-17T22:40:04+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
...
\cite{jaynes1954_r1974,sivia1996_r2006,meadetal1984} achieve this kind of
compression: they associate a unique probability distribution with few
experimental quantities \cite{***}. But this is only one of their uses.
They are also used for various information-theoretic purposes or to
generate reference probability distributions \cite{***}. In all these uses
the \me\ distribution is chosen as the \enquote{maximally noncommittal} one
\cite{jaynes1963}. This adjective means little without further technical
characterizations. Different works give different characterizations, and in
