...
%% Last-Updated: 2017-05-15T18:21:39+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
...
Recent advances in electrophysiological recordings allow to
 study the collective behavior of large population of neurons 
in relation to stimuli and bahavioral tasks [\cite]. Huge amount of parallel
 recordings from hundreds of neurons, available today, is accompanied by
 the statistical challenges to shed light on the mechanism behind neuronal coding. 
The principle of \me\ was proposed as a way to overcome these challenges by constructing a full description of the 
neuronal firing patterns based on only first and second order statistics of the observed data [\cite].

 used in neuroscience to study the patterns of neuronal
 firing in relation to stimuli or behavioral tasks. These studies strive for understanding the 
mechanism behind neuronal coding. 
 by answering
 ...
 of neurons can be related to stimuli or behavioral tasks [\cite]? These questions 
**********
\mynote{Version 1}
...
\caption{\mynote{shorten }Example of discrepancy in $\p(\yxs = \yrs \| \yH)$ constructed by
...
Figure~\ref{fig:diff_maxent_pop_sample} shows one example, for values
$N=5\,000$, $n=100$, $c_1=0.45$, $c_2=0.35$, yielding $\yL_1 = -13\,321.9$,
$\yL_2 = 13\,321.5$, $\yl_1=-269.3$, $\yl_2 = 268.9$, and appropriate
normalization constants. Another example is shown in
\fig~\ref{fig:diff_maxent_pop_sample_realdata}, for neurobiologically more
realistic constraints $c_1=0.045$, $c_2=0.0025$, and $N=5\,000$, $n=200$,
yielding $\yL_1 = -16\,834.0$, $\yL_2 = 16\,825.7$, $\yl_1=-673.5$,
$\yl_2 = 665.1$. The discrepancy, although not as large as in the previous
example, is still relevant for the tails of the distributions.
