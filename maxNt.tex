...
%% Last-Updated: 2017-05-12T13:15:15+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
...
completely clear. For our purposes we can simply say that the \me\ method
is assumed to generate a \enquote{maximally noncommital} \cite{jaynes1963}
probability distribution. We intend the quoted expression only as an
umbrella term, also because it  means very little without further
clarifications.

The neurons recorded in these kinds of experiments are not usually
