...
%% Last-Updated: 2017-05-15T00:15:08+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
...
$\p(\yxs=\yrs \| \yH)$; see \fig~\ref{fig:diff_maxent_pop_sample}. Which
should we choose?

\begin{figure}[!b]
\centering
\includegraphics[width=0.95\columnwidth]{different_maxent_pop_sample.pdf}%
\caption{Example of discrepancy in the probability $\p(\yxs = \yrs \| \yH)$
  constructed by \me\ at the population level followed by sample
  marginalization (blue triangles), and at the sample level (red circles).
  The constraints are the same in both applications:
  $\expe{\yxs \|\yH}=0.45$, $\expe{\yxxs \|\yH}=0.35$, and $N=5\,000$,
  $n=200$.}
