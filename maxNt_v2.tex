...
%% Last-Updated: 2018-05-12T16:21:17+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
...
\begin{equation}
  ...
  \p(\text{activity at one time bin} \|
  \text{activities at the remaining bins, and other info}).
\end{equation}
...
\begin{multline}
  ...
  \p(\text{activity at one time bin} \|
  \text{activities at the other bins, and other info}) ={}\\
  \p(\text{activity at some time bin} \|
  \text{1st \amp\ 2nd empirical moments, and other info});
\end{multline}
...
\begin{multline}
  ...
  \p(\text{activity at bins $1,2,\dotsc$} \|
  \text{other info}) ={}\\
  \shoveright{\int
    \pf(\text{activity at bin $1$} \|\ytheta)\,
    \pf(\text{activity at bin $2$} \|\ytheta)\dotsm
 \pf(\ytheta\| \text{other info})\,
  \di\ytheta,}
  \\[2\jot]
  \text{with \enquote{$\pf(\text{activity at time bin $i$} \|\ytheta)$}
    having maximum-entropy form};
\end{multline}
the $\ytheta$ being the Lagrange multipliers of the maximum-entropy
distribution. The proof that the assumption of sufficient statistics leads
...
maximum-entropy one with those Lagrange multipliers. This kind of
distribution has been used at least since the 1990s
\cite{mackay1991,martignonetal1995,bohteetal2000,amarietal2003,schneidmanetal2006,shlensetal2006,tkaciketal2006,mackeetal2009,mackeetal2009b,roudietal2009,roudietal2009b,roudietal2009c,tkaciketal2009,gerwinnetal2009,barreiroetal2010b,mackeetal2011,mackeetal2011b,ganmoretal2011,granotatedgietal2013,mackeetal2013,tkaciketal2014b,moraetal2015,shimazakietal2015}
