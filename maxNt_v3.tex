...
%% Last-Updated: 2018-05-15T12:04:44+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
...
$(R_1,\dotsc,R_N)\defs \yR \in \set{0,1}^N$; \enquote{$X$} denote the
variable, and \enquote{$R$} its value. A particular sample of $n$ neurons
...
identities. This ignorance leads us to assign a probability distribution
for the population state $\yX$ that is symmetric under permutations of
neuron identities; such a distribution is usually called \emph{finitely
  exchangeable} \cites{ericson1969}[\chap~1]{ghoshetal1997}. We stress that
this probability assignment is just an expression of the symmetry of our
