...
%% Last-Updated: 2018-05-18T11:53:47+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
...
\newcommand*{\pdftitle}{Maximum-entropy and samples of neuronal
  activity:\\the importance of the larger population}
...
\enquote{hidden} neurons \cite{smolensky1986,hintonetal2006}. The problem
...
\emph{is} the full population, and no larger population exists or the
recorded neurons are completely isolated from it.
...
\item What is the mathematical relation between the new application and
  \me\ models with hidden neurons \cite{smolensky1986,hintonetal2006}?
\end{itemize}
