...
%% Last-Updated: 2018-09-13T14:10:47+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Report-no: ***
...
way the \me\ method itself, as sketched above, is applied to the activity
of the recorded neurons. We believe that this problem is at the root of
some quirks about this method that were pointed out in the literature
\cite{roudietal2009b}. This problems extends also to more complex versions
of the method, possibly except versions that use \enquote{hidden} neurons
\cite{smolensky1986,kulkarnietal2007,huang2015,dunnetal2017}. The problem
is that the recorded neurons are a \emph{sample} from a larger, unrecorded
...
%% from Yasser:
** we want to describe average activities so our initial knowledge
disregards details

** we assume sample is representative of full population, so our initial
knowledge is symmetric

\mynote{modidy this}We need to make an initial probability assignment for the state of the full
...
PGLPM thanks Mari \amp\ Miri for continuous
encouragement and affection; Buster Keaton for filling life with awe and
inspiration; the developers and maintainers of \LaTeX, Emacs, AUC\TeX, Open
Science Framework, Python, Inkscape, Sci-Hub for making a free and
