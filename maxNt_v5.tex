...
%% Last-Updated: 2019-04-19T19:09:13+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
The maximum-entropy principle was proposed by Jaynes
...
\begin{quote}\footnotesize
  ...
  probabilities?
\end{quote}
The idea behind this principle is to translate \emph{all} the data we're
...
principle is approximately equivalent, under specific conditions, to a
...
Sometimes this principle is applied with only \emph{part} of the available
data used as constraint; such an altered approach can be a heuristic way of
testing for sufficient statistics.

Owing to its directness, the maximum-entropy principle is straightforward
...
In the present work we show how to use the maximum-entropy principle to
...
thousands of neurons, by analysing recording of only a few tens or hundreds
of them.
