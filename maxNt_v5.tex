...
%% Last-Updated: 2019-07-13T11:35:37+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{figure}[!p]
\centering
\includegraphics[width=\linewidth]{_scripts/MC_plot_unif1000.pdf}%
\\[3em]%
\includegraphics[width=\linewidth]{_scripts/MC_marginal_unif1000.pdf}%
...
\begin{figure}[!p]
\centering
\includegraphics[width=\linewidth]{_scripts/MC_plot_dirich1000.pdf}%
\\[3em]%
\includegraphics[width=\linewidth]{_scripts/MC_marginal_dirich1000.pdf}%
