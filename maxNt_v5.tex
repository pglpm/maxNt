...
%% Last-Updated: 2019-07-25T13:53:17+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
This method has often been used to test whether a smaller part of the data,
for example time averages and second-order correlations, is sufficient for
quantifying our \dob\ about some aspects of the neuronal activity. We'll
consider this particular application also for our proposed model.
Maximum-entropy models can be considered as approximations of Bayesian
models based on various assumptions of inferential sufficiency
...
with which all levels of total activity of a larger network of thousands of
