...
%% Last-Updated: 2019-07-10T11:49:38+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
considering the mode of such densities. Let's be more concrete. Consider
the question: What is the relative-frequency distribution for the different
activity levels for the full-network, across the recorded bins? Call this
distribution $(\yFF_{\yA}) \defs \yF$: activity level $\yA$ appeared in
$T\,\yFF(\yA)$ out of $T$ time bins. We don't know $\yF$, and our
uncertainty about its possible values is a probability distribution
