...
%% Last-Updated: 2019-04-09T14:46:50+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
There are several ways to build and interpret a distribution of the
maximum-entropy form~\eqref{eq:app_maxent_sample}
or~\eqref{eq:app_maxent_pop}.

The maximum-entropy method is used to construct a complete plausibility
distribution given only a quantitative \emph{feeling} of some of its
properties, such as expectations. This way of constructing probabilities
may be needed at the very beginning of an inference
problem\footnote{\enquote{Now the axioms of probability enable us to infer
    any probability-conclusion \emph{only} from probability-premisses. In
    other words, the calculus of probability does not enable us to infer
    any probability-value unless we have some probabilities or probability
  ...
  \citep[\emph{Appendix on eduction}, \sect~5, p.~182]{johnson1924}.}
\cites[pp.~52--55, 72--77]{jaynes1979b}[pp.~25--28]{jaynes1982}[\sect~I]{jaynes1982b}{jaynes1986d_r1996}[\sect~11.1]{jaynes1994_r2003}.

In the present case, however, the probability distribution can be derived
through the probability calculus from the precise empirical statistics and
observations made; the initial probabilities and assumptions needed in such
an inference are of a different kind. It can be shown that the
maximum-entropy distribution is an \emph{approximation} of the exact result
obtained this way.
