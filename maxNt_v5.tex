...
%% Last-Updated: 2019-06-13T11:51:25+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
the maximum-entropy method. In short, it amounts to choosing the
distribution having maximum Shannon entropy among those satisfying specific
convex constraints, such as expectation values; these expectations are
typically chosen to be equal to measured averages. We add two remarks that
you may not be familiar with. First, the \enquote{distribution} given by
this method is the zeroth-order approximation of four different
distributions:
\begin{itemize}
...
equate our expectations to. Here enters point~\ref{item:sample_step}:
classical sampling theory
\citep[for example][\chaps~I--IV]{whitworth1867_r1965}[\chap~II]{feller1950_r1968}[\chap~3]{jaynes1994_r2003}[see
also][]{whitworth1897}.
