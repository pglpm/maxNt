...
%% Last-Updated: 2019-06-12T20:30:19+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
Regarding point~\ref{item:maxent_step}, we assume the reader to be familiar
with the maximum-entropy method. In short, it amounts to choosing the
distribution having maximum Shannon entropy among those satisfying specific
convex constraints, such as expectation values. We add two remarks. First,
...
\end{itemize}
So the maximum-entropy \enquote{distribution} is an approximate answer to
four conceptually different inferences. Note that although these four
distributions numerically coincide in this approximation, they numerically
differ in higher-order approximations. Second, the maximum-entropy method
based on the Shannon entropy implicitly makes specific assumptions about
the probability of the long-run frequency distributions
...
population we need to set some of its expectation values, for example its
moments. Here enters point~\ref{item:sample_step}:
