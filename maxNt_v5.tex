...
%% Last-Updated: 2019-05-12T18:09:32+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
Answering this kind of questions always involves an element of uncertainty.
Our answers therefore involve experimental data, such as neuronal
recordings from specific brain areas, but also probabilistic assumptions --
probabilistic \enquote{models} -- about biological conditions and
mechanisms that cannot be experimentally ascertained.

Despite fast advances in recording technologies, our best experimental
...
probabilistic models focus on such samples only,
