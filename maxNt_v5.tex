...
%% Last-Updated: 2019-06-25T17:40:21+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\emph{not} to be sufficient for any recorded sample thereof.

It seems to us that such questions about sufficient statistics are
implicitly asked for specific brain areas, not for casually recorded
samples thereof. Thus, maximum-entropy methods applied at the sample level
