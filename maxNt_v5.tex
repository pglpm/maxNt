...
%% Last-Updated: 2019-07-25T14:43:18+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
pre-data \dobs\ are often simplified and called \enquote{models} to be
...
calculus. The maximum-entropy or minimum-relative-entropy method
...
We illustrate possible uses of our proposed model by applying it to two
concrete data sets:
...
explain how our approach bypasses it. Moreover, our proposed model gives
clearer answers to questions of correlation sufficiency: we show this by
applying it to the two data set above addressing an example question of
sufficiency: two moments versus four moments.




Maximum-entropy models can be
considered as approximations of Bayesian models based on various
assumptions of inferential sufficiency
\citep{jaynes1986d_r1996,portamana2017}.
...
We also apply the model to the question of informational sufficiency of
lower-order moments
