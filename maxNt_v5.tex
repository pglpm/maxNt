...
%% Last-Updated: 2019-07-11T11:28:12+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\textbullet\ The density $\exp[-\yL\;\ysh(\yF;\yR)]$ expresses our pre-data
...
likelihood of the frequency $\yF$ in view of the data $\yc$. The matrix
$\ycm$ 
