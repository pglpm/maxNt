...
%% Last-Updated: 2019-04-18T16:17:13+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
These premisses may represent either actual knowledge or just some
hypotheses whose consequences we want to explore. They can be
...
assigned at different depths of the logical analysis of our inference
problem, and assignments at different depths can turn out to be
equivalent.

We can for example assign probabilistic premisses at a very deep
level, as schematically illustrated on the left. They will determine the
probabilities of statements at all higher levels, including the statements
we're ultimately interested in.

Or we can assign probabilistic premisses at
a level of intermediate
\begin{wrapfigure}{r}{0.33\linewidth}% with wrapfigure
\centering\includegraphics[width=\linewidth]{statements_scheme2.pdf}%\\
%\caption{caption}\label{fig:comparison_a5}
\end{wrapfigure}% statements_scheme.svg statements_scheme2.svg
depth, as schematically illustrated on the right. In this case they will
determine the probabilities of statements at all higher level, and partly
constrain the probabilities of statements at deeper levels.
