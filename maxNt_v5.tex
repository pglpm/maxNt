...
%% Last-Updated: 2019-06-13T14:42:35+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
for the full population and the first $m$ for the sample, so that the ones
...
we have that the latter averages determine the moments for the full
population:
\begin{equation}
  \label{eq:chain_prescription_moments}
  \text{measured averages} \longrightarrow
  \text{sample moments} \longrightarrow
  \text{full-population moments}
\end{equation}
...
activity of a population of $n$ neurons. The $m$th factorial moment can be
