...
%% Last-Updated: 2019-07-08T23:05:19+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
In the neurosciences, the maximum-entropy method has often been applied to
questions of sufficient statistics. In this section we discuss how our
proposed application bears on this kind of questions. For concreteness
we use an example with specific statistics: first and second moments
(equivalent to mean and correlations), versus first-to-fourth moments. But
our discussion holds for any other sets of statistics.
...
activity in a new time bin. For this assessment we use any measured data we
have. But it sometimes happens that dropping part of the data -- for
...
assessment almost unchanged: the dropped data are \emph{informationally
  irrelevant}, or \emph{almost} so. The data that remain -- for example,
first and second moments -- are \emph{informationally sufficient}. This
informational quasi-sufficiency may be connected to biological or physical
mechanisms; that's why it's interesting.

We can approximately check which data are irrelevant by simply dropping
them from the conditional of our degree of belief, and see if the latter
changes appreciably. When our degree of belief is built with the
maximum-entropy method, we simply drop some of the data used as constraints
and see how the resulting distribution changes. In the neurosciences this
has been done with maximum-entropy distributions constructed \emph{for the
  sample}.
...
application to the sample. The issue doesn't come from the method itself
but from a simple, general fact of probability theory. If a probability
...
for trivial cases such as uniform distributions. This in general also holds
between different marginals: if a marginal has some sufficient statistics,
...
\end{figure}
%mctests3.nb
%plot_mcfd_6mom_unif_afssd26_cok_tr_N1000_t50_L50_T0.333333333333333_s60000_a0
