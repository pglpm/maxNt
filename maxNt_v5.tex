...
%% Last-Updated: 2019-07-25T11:36:58+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
larger brain area where a sample comes from, but without adding too much
...
network be, if we have observed the activity of a very small sample
thereof? This model addresses a larger brain area, avoiding the assumption
of isolation of the sample. And by focusing on the total activity, rather
than the activity of individual neurons, it remains simple and numerically
tractable.
...
We apply our proposed model to two concrete data sets:
\begin{enumerate*}[label=(\alph*)]
\item the activity of 65 neurons recorded from a rat's Medial Entorhinal
  Cortex \citep{stensolaetal2012}, \item the activity of 159 neurons
  recorded from a macaque's Motor Cortex \citep{rostamietal2016_r2017}.
\end{enumerate*}
For each data set the model yields***

In the first data set, the most
