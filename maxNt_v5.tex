...
%% Last-Updated: 2019-07-08T13:40:41+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
shows the maximum-entropy distributions for the sample (dashed curves),
from two moments (\textcolor{mygreen}{empty green triangles}) and from four
moments (\textcolor{mygreen}{empty blue squares}), and the distributions
obtained by marginalizing the full-network distribution to the sample size
(solid curves), from two moments (\textcolor{mygreen}{filled green
  triangles}) and from four moments (\textcolor{mygreen}{filled blue
