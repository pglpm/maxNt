...
%% Last-Updated: 2019-06-19T19:49:04+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
already provides as much information as the full frequency distribution of
the sample, and at the same time illustrates the use of the approach in
questions of statistic sufficiency (typically limited to two or three
moments). Figure~\ref{fig:plots_6mom} shows the resulting densities
(distribution/activity-step, that is, distribution${}\times N$) for
full-network sizes $N=n$, $N=1\,000$, $N=5\,000$,
$N=10\,000$\mynote{motivate?}. The case $N=n$ corresponds to applying the
...
calculus to make forecasts about the full network thus reveals interesting
and useful features.
...
unimodal one, showing that two moments would not be a sufficient
...
\section{Marginalization to the sample level}
