...
%% Last-Updated: 2019-07-09T16:57:47+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
application at the sample level. The issue doesn't come from the method
...
addressed to a whole brain area, not just to some casually recorded sample.
Thus, paradoxically, maximum-entropy methods applied at the sample level
give an answer opposite to the one we might think they're giving.
...
one. Figure~\ref{fig:comparisons_marginals} gives a graphical answer to
this question in the case of our first data set. The upper plot shows the
...
marginalizing the full-network distribution to the sample size, from two moments (\textcolor{mygreen}{$\bm{\blacktriangledown}$})
and from four moments (\textcolor{myblue}{$\bm{\blacksquare}$}). The
measured frequency distribution (\textcolor{myred}{\LARGE$\bm{\bullet}$}) is also
...
are approximations to the full answers provided by the probability
calculus. For example we ask: what is the frequency distribution for the
total activity of the full network across the recorded bins? Several
frequency distributions are possible, each with a specific probability. The
maximum-entropy distribution is



***mode of marginal can be very different from the one in full space (minka1998)
