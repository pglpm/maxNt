...
%% Last-Updated: 2019-07-20T18:44:47+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
there's an area, comprising a network of $N$ neurons, for which we equally
believe that any other sample of size $n$ could have been recorded instead
of the sample of $n$ neurons that was actually recorded. This is our
\enquote{full network}.\mynote{how about calling it \enquote{the pool}?}
The normalized total activity of these $N$ neurons at $t$ is $\yA_{t}$. The
relative frequencies of the various activity levels during the recording
were $(\yFF_{\yA}) \defs \yF$. We don't know the values $\yA_{t}$ at each
$t$, or the frequency distribution $\yF$. We only know for certain that
