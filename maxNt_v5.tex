...
%% Last-Updated: 2019-07-22T11:30:14+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{itemize}
\item all activities $\yA \lesssim 0.05\%$ have practically zero frequencies;
\item there are two regions of activity levels with high frequencies,
  ...
  the region on the left ($\yA \lesssim 0.018\%$) are higher than those of
  the region on the right ($\yA \gtrsim 0.018\%$).
\end{itemize}
...
the sample, but also on our pre-data beliefs about the distribution. Which
assumptions lie behind the maximum-entropy approximation?
