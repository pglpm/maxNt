...
%% Last-Updated: 2019-06-10T16:14:24+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
inferences about the \emph{total activity} of a large neuronal network can
we make by recording a very small sample thereof? The answer we'll give
comes from the simple combination of basic sampling probability relations
and the maximum-entropy method.\mynote{shall we give a two-sentence summary
  of the main idea here?}

The maximum-entropy method\mynote{refs} has been used for a variety of
inferences about the neuronal activity of various brain areas and about
other phenomena of importance to the neurosciences, for example gene
regulation and protein sequencing\mynote{what's this exactly? refs}. This
method is often used to test whether some statistics of the data, for
example second-order time correlatins, is sufficient for making other
