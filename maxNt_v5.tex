...
%% Last-Updated: 2019-07-10T14:04:12+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
We therefore want to assess how well the maximum-entropy distributions of
\fig~\ref{fig:plots_6mom} answer our two questions above. We do this by
sampling from the probability density $\pf(\yF \| \yD \yI)$ through
Markov-chain Monte Carlo. The density is
\begin{equation}
