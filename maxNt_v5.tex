...
%% Last-Updated: 2019-06-25T17:30:45+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
impossibility is known in statistical mechanics: marginals of Gibbs states
aren't Gibbs states \citep{maesetal1999}. Mathematically it corresponds to
the general impossibility of solving a system of $n$ equations in $m$
unknowns when $n>m$
...
then they \emph{cannot} be sufficient for the full network; and vice versa,
if we assume that they are sufficient statistics for the full network, then
we must expect them \emph{not} to be sufficient for any recorded sample
