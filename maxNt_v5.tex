...
%% Last-Updated: 2019-06-11T15:16:29+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
the total activity of the full population, if the latter is assumed to be
...
set doesn't have two modes but still presents one prominent shoulder in the
low-activity mode. Note that these inferred features for the full
population aren't observed in the sample, nor are they inferred by the
application of maximum-entropy to the sample alone.
