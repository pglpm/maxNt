...
%% Last-Updated: 2019-04-19T15:23:02+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{quote}\footnotesize
  ...
  probabilities?
\end{quote}
Its idea is to translate \emph{all} data we're given as constraints for our
probability assignment, resolving the leftover freedom by choosing the
...
\citep{jaynes1986d_r1996,rodriguez1989,rodriguez2002,skilling1989b,skilling1990}[\sect~4.5]{bernardoetal1994_r2000}{diaconisetal1981,portamana2009,portamana2017}.

Owing to its directness, the maximum-entropy principle is straightforward
to use -- and to misuse. In our previous example, for instance, it gives
silly results unless the number of time bins is much larger than the
