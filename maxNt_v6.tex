...
%% Last-Updated: 2019-12-15T20:01:34+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
end of this section for references to in-depth discussions and technical
results.
...
This notion is useful in our present problem owing to its tight
mathematical connection with maximum-entropy distributions, in the form of
a theorem: \emph{if a probability distribution for repetitive phenomena has
  a sufficient statistics, then it is a mixture of distributions of
  maximum-entropy form, and vice versa}. Thus, maximum-entropy
distributions automatically appear (as approximations) from the
probability-calculus when we test hypotheses about sufficiency.
