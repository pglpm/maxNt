...
%% Last-Updated: 2019-11-16T18:08:44+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
A natural procedure to compare the informational sufficiency of two
different sets of moments $M'\defd\set{1,\dotsc,m'}$ and
$M''\defd \set{1,\dotsc,m''}$ is as follows:
\begin{enumerate*}[label=(\roman*)]
\item calculate the relative entropies of the measured frequencies $\yf$
  and the sample marginals of the maximum-entropy distributions built with
  the two corresponding sets of constraints;
\item multiply these relative entropies by the number of time bins of the
  recording;
\item take their difference.
\end{enumerate*}
In formulae,
\begin{multline}
  \label{eq:measure_suffic}
T  \sum_{\ya} \yff_{\ya} \log\frac{\yff_{\ya}}{
...
This is a natural measure because
