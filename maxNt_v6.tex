...
%% Last-Updated: 2019-11-18T13:35:04+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
We first calculate the distribution by using five moments. This number
already provides almost as much information as the full frequency
distribution of the sample (see \sect~\ref{sec:marginalization}).
Figure~\ref{fig:plots_5mom} shows the resulting densities (that is,
...
this equality in appendix**. So the exponential of $\ydi(M'',M')$ tells
us how much more probable the data $\yf$ are, conditional on $M''$ versus $M'$. If
we assign the pre-data probabilities of the two hypotheses, this measure
also gives us the ratio of their probabilities conditional on the data.
...
of the first two, four, five moments. For a full network of size
...
of the first four moments than under sufficiency of the first two only; but
they are about equally probable ($10^{0.016} = 1.04$) whether we consider
the first five moments to be sufficient or just the first four.
...
The conclusions regarding \enquote{cooperativity} or \enquote{interaction}
