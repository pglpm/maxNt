...
%% Last-Updated: 2019-11-21T16:46:09+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
distribution of the sample (see next section). Figure~\ref{fig:plots_5mom}
shows the resulting densities (distribution${}\times N$) for three example
values of full-network sizes: $N=1\,000$, $N=5\,000$, $N=10\,000$. The
frequency distribution of the sample activity is also shown, and in the
plot it is indistinguishable from the maximum-entropy distribution for
