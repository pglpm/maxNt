...
%% Last-Updated: 2019-11-13T16:55:17+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
points further in \sect~\ref{sec:assumptions}.
...
to the sample's recorded average of $\tbinom{\ya}{m}\;\tbinom{n}{m}^{-1}$,
for as many $m$ as we please with $1\le m \le n$. In formulae these
constraints on $\px(\yA)$ are
\begin{equation}
  \label{eq:final_constraint}
\underbracket{\frac{1}{T}\sum_{t}\binom{\ya_{t}}{m}\,\binom{n}{m}^{-1}
  \equiv
   \sum_{\ya}
  \binom{\ya}{m}\,  \binom{n}{m}^{-1} \yff_{\ya}}_{\text{measured moments}}
  =
   \underbracket{\sum_{\yA}
  \binom{\yA}{m}\,  \binom{N}{m}^{-1}\, \px(\yA)}_{\text{distribution moments}}
\end{equation}
for all $m$ we wish.
