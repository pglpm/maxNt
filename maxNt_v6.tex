...
%% Last-Updated: 2019-12-01T23:27:33+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
approximations become clear within a full-fledged probabilistic approach to
our inference problem, at least qualitatively sketched.

The first and most important assumption of this kind of maximum-entropy
application in neuroscience is that the order of the time bins has no
relevance; or equivalently that the frequencies of the activity during a
recording are informationally sufficient. *** markov here \citep{diaconisetal1980c,geetal2012} *** Note that the
maximum-entropy method in statistical physics is meant to be used not with
this assumption, but with averages across \emph{repetitions} of the same
experiment: its constraints represent macroscopically \emph{reproducible}
quantities and kinematics, even in non-equilibrium
...
Both assumptions above make sense as hypotheses for judging the
