...
%% Last-Updated: 2019-12-15T16:26:55+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
and hypotheses under study. We give some examples in the
next two sections.

Note that the constraint equation~\eqref{eq:final_constraint} for the
distribution~\eqref{eq:app_maxent_pop_first} may not have solutions
if $N$ is strictly larger than $n$, but it's still possible to find The possible discrepancy between its
...
\item an entropic prior \citep{skillingetal1984,rodriguez1991,neumann2007}
  ...
  lower-dimensional subset thereof, parametrized by $\yla$.
\end{enumerate}
