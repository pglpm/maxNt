...
%% Last-Updated: 2019-11-25T19:19:26+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
isn't the sole contributor. We can also assess if the distributions for the
two sets are independent. If they were independent, the full-population
distribution would be given by their convolution:
\begin{equation}
