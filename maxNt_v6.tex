...
%% Last-Updated: 2019-11-19T16:21:29+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
moment~\eqref{eq:def_factorial_moment_a}, the expression for the hypergeometric
distribution~\eqref{eq:conditional_hypergeometric}, and the
relation~\eqref{eq:belief_sample_unknown_A} between our beliefs about $\ya$
and $\yA$, it is possible to prove using some combinatorial juggling the
...
constraints see Jaynes \citey{jaynes1963}[\chap~11]{jaynes1994_r2003}. More
precisely we use the minimum relative-entropy principle
...
problem see Mead \etal\ \citey{meadetal1984} and the extensive text by Fang
\etal\ \citey{fangetal1997}.
