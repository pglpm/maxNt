...
%% Last-Updated: 2019-11-25T18:44:15+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  ...
  P_{\text{full}}(\yA) =  \smashoperator{\sum_{\yA'=\max(0,\yA-5850)}^{\min(\yA,4150)}} P_{\text{grid}}(\yA')\;
...
that this method is computationally very cheap but can provide useful
insights, even if just qualitatively.
