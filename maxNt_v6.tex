...
%% Last-Updated: 2019-12-01T15:24:42+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
$(\ya_{t}, \yA_{t})$, would involve the joint frequencies of total
activities of sample and larger population $F_{\ya,\yA}$, multiplied by the
...
\begin{equation}
  ...
  \prod_{\ya,\yA}\bigl[\underbracket{\vphantom{\underline{g}}\yG_{\ya\yA}\;\pxx(\yA)}_{\mathclap{\textit{sampling relation}}}\bigr]^{T\,F_{\ya,\yA}}.
\end{equation}
...
\begin{enumerate*}[label=(\roman*)]
\item the probability for the total activity $\yA$ becomes equal to its
  observed frequency;
...
$n\times N$. Discrepancies of order $nN/T$ are therefore expected.
