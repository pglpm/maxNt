...
%% Last-Updated: 2019-12-02T22:37:28+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
The final assumption of the maximum-entropy method concerns the form of the
probability density $\pxx(\ynu)$ in the expressions above. It is taken to
be either an \enquote{entropic prior}
\citep{skillingetal1984,rodriguez1991,neumann2007}, which partially takes
...
model under study \citep{portamana2017}. This assumption is crucial for
obtaining the maximum-entropy method with the Shannon entropy. A different
density would lead to alternative maximum-entropy methods, for example
