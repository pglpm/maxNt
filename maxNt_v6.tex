...
%% Last-Updated: 2019-12-04T17:01:22+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
into account the multiplicity of long-run frequencies through a coefficient
$L$, and a reference distribution, or a prior for a model with sufficient
statistics, which expresses the sufficiency of the moments under study
\citep{portamana2017}. This assumption is crucial for obtaining the
maximum-entropy method with the Shannon entropy. A different density leads
to alternative maximum-entropy methods, for example based on the Burg
entropy \citep{burg1975} if a Dirichlet density is used
\citep{jaynes1986d_r1996}.
