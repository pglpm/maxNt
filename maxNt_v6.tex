...
%% Last-Updated: 2019-11-16T19:24:32+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{multline}
  ...
  \text{difference in informational sufficiency between $M'$ and $M''$} \defd{}\\
T  \sum_{\ya} \yff_{\ya} \ln\frac{\yff_{\ya}}{
  \sum_{\yA}\yG_{\ya\yA}\px(\yA \| M')}
-
T  \sum_{\ya} \yff_{\ya} \ln\frac{\yff_{\ya}}{
  \sum_{\yA}\yG_{\ya\yA}\px(\yA \| M'')} \equiv{}\\
T  \sum_{\ya} \yff_{\ya} \ln\frac{
  \sum_{\yA}\yG_{\ya\yA}\px(\yA \| M'')}{
  \sum_{\yA}\yG_{\ya\yA}\px(\yA \| M')}.
\end{multline}
Why is this a natural measure? Let's ask how much more probable is the
