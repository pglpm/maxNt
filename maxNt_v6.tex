...
%% Last-Updated: 2020-01-14T13:49:20+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
The question of how large can the larger population addressed by
model be, and the assumptions on which the model is based, from a Bayesian
...
let us thus turn the informational sufficiencies of two different subsets
of statistics into two \emph{hypotheses}. We can then ask: which hypothesis
is more probable, given the data? Equivalently, what is the ratio of their
...
maximum-entropy method based on the Shannon entropy. Different prior
...
indicate that these typical features are robust for different prior choices
...
\begin{acknowledgements}
  ...
  We thank Iv\'an Davidovich for very insightful and helpful comments on a
  previous draft of this manuscript. PGLPM thanks the staff of the NTNU
  library for their always prompt support; Mari, Miri, \amp\ Emma for
