...
%% Last-Updated: 2019-12-06T12:02:48+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\section{Introduction:\\a model for questions about large neuronal
  populations}
\label{sec:intro}
...
brain areas, and pre-data knowledge and assumptions about biological
conditions and mechanisms. Our pre-data \dobs\ are often simplified, to be
mathematically tractable, and are therefore called \enquote{models}.
...
In the present work we propose such
...
model can lead to the formulation or preliminary assessment of interesting
...
How large is the full population addressed by the model proposed here? Its
...
approximations on which the model is based, from the point of view of the
...
time bin during a recording? The model presented here gives a
