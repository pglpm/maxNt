...
%% Last-Updated: 2019-12-14T18:18:53+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\citep{dunnetal2013,huang2015,battistinetal2017,pillowetal2008}. It would be useful to explore models
...
at least for preliminary investigations, to help us decide which hypotheses
to consider or discard for more complex and costly models, or to suggest
new hypotheses.
...
Step~\ref{item:sample_step} is just an application of the probability-calculus, which gives an exact linear relation between the first $m$
moments for the larger population and the first $m$ for the sample
\citep[Appendix]{portamanaetal2015}. The ones determine the others and
...
probability expectations and empirical averages are numerically
different in general; a misjudgement of their approximate equality can lead to
\enquote{silly answers}, to quote Mackay \cite*[p.~308]{mackay1995_r2003}.)
...
zeroth-order (Laplace
\citep[\chap~4]{debruijn1958_r1961}{tierneyetal1986,strawderman2000})
approximation of four distinct distributions for the larger population,
which differ numerically from one another in higher-order approximations:
