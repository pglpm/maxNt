...
%% Last-Updated: 2019-12-21T00:46:31+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
level (equivalent to $N=n$) to the first data set. With the $M_{2}$ and
$M_{4}$ constraints we obtain the distributions partly shown in
\fig~\ref{fig:comparisons_marginals} for two (\textcolor{myred}{red empty
  circles}) and four (\textcolor{myblue}{blue empty squares}) moments. The
measured frequencies (black triangles) are also shown. The two
distributions can only be distinguished on a logarithmic scale, and only in
their tails. It would be difficult to visually assess which is more likely
to be informationally sufficient.
...
\begin{equation}
  \label{eq:diff_suff_n}
  \begin{split}
  \ydi_{n}(M_{4},M_{2}) &= 400\;\bit = 120\;\hart,
\\    \ydi_{n}(M_{5},M_{4}) &= 4.8\;\bit = 1.4\;\hart.
\end{split}
\end{equation}
...
\begin{equation}
  \label{eq:diff_suff_n}
  \ydi[(M_{4}, N), (M_{4}, n)] = 56\;\bit = 17\;\hart.
\end{equation}
