...
%% Last-Updated: 2019-12-02T10:04:27+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
An assumption of our specific application is that all subsets of $\yA$
...
sample and larger population $F_{\ya,\yA}$, multiplied by the number of
time bins $T$:
\begin{equation}
  \label{eq:prob_joint_frequencies}
  \underbracket{\prod_{t} \pxx(\ya_{t}, \yA_{t})}_{\mathclap{\textit{prob. of joint sequence}}} \equiv
  \prod_{\ya,\yA} \pxx(\ya, \yA)^{T\,F_{\ya,\yA}} =
  \prod_{\ya,\yA}\bigl[\underbracket{\vphantom{\underline{g}}\yG_{\ya\yA}\;\pxxx(\yA)}_{\mathclap{\textit{sampling relation}}}\bigr]^{T\,F_{\ya,\yA}}.
\end{equation}
