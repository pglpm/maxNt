...
%% Last-Updated: 2019-11-26T10:47:14+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
which all levels of total activity of a larger population of
1\,000--10\,000 neurons appeared during the recording. These guessed
frequency distributions are distinctly different from the recorded ones for
the sampled neurons. For the first data set, for example, the frequency
...
normalized activities as the peaks of the full-population distribution
...
full population, but it is not the sole contributor. We can also assess if
the distributions for the two sets of neurons are independent. If they were
independent, the full-population distribution would be given by their
convolution:
\begin{equation}
...
full-population distribution (\textcolor{myblue}{blue curve}): the two
...
% sample becomes the full population as $n\to N$. In particular, these limits
