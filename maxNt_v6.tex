...
%% Last-Updated: 2019-12-21T23:54:35+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
% \\[3em]%
\includegraphics[width=0.95\linewidth]{_scripts/trunct2_comparison_marginals.pdf}%
\caption{Maximum-entropy distributions constructed at the sample level
  ($N=n$), based on the first two, four, and five moments; and sample
  marginal of the distribution constructed with five moments for a larger
  population with $N=10\,000$ (dotted yellow in
  \subcaptionref{fig:plots_2_4mom_a}). The distributions at the sample
  level are all very similar, only distinguishable on a logarithmic scale.
  The five-moment distribution constructed at the larger-population level
  fits the frequency data better than the one at the sample level.}
