...
%% Last-Updated: 2019-11-17T00:27:31+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\item calculate the relative entropies of the measured frequency
  ...
  \begin{equation}
    ...
    T\,\sh[\yf; \pxx(\ya \| M)] \defd  T  \sum_{\ya} \yff_{\ya} \ln\frac{\yff_{\ya}}{
      \pxx(\ya \| M)},
    \qquad M=M',M'';    
  \end{equation}
...
Why is this a natural measure? Because, if we assign equal pre-data
probabilities to the two hypotheses $M''$ and $M'$, then the exponential of
$\ydi(M'',M')$ is approximately equal to the ratio of their probabilities
conditional on the data $\yf$ -- their Bayes factor:
\begin{equation}
  ...
  \pf(M' \| \yf)\bigr].
\end{equation}
So the exponential of $\ydi(M'',M')$ tells us how much more probable $M''$
is than $M'$, in view of the data $\yf$. We prove this in appendix**
