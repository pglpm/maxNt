...
%% Last-Updated: 2019-11-14T00:39:01+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
comparison. In both data sets, the two-moment constrain leads to a
distribution quite different from the four-moment constrain. For the first
data set in particular, one distribution is bimodal, the other unimodal,
showing that two moments are not informationally sufficient.

It's useful to contrast the distributions for the full network with those
obtained applying the maximum-entropy method \emph{at the sample level}
with the same constraints, as traditionally done. The sample-level
