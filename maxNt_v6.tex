...
%% Last-Updated: 2019-12-20T11:10:29+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
precise, operational \citep[\chap~I]{bridgman1927_r1958} notion. Here we
propose the notion of \emph{informational sufficiency} (also called
\enquote{predictive sufficiency})
\citep{kullbacketal1951}[\sect~4.5]{bernardoetal1994}[\chap~8 and
\sect~14.2]{jaynes1994_r2003}, because
\begin{enumerate*}[label=(\roman*)]
...
\end{enumerate*}
Its meaning and the three points above will now be illustrated; please see
the end of this section for references to in-depth discussions and proofs
...
But such a translation does more: through a mathematical theorem, it leads
to the automatic appearance of maximum-entropy distributions: \emph{if a
  probability distribution for a repetitive phenomenon has some sufficient
  statistics, then it is a mixture of distributions of maximum-entropy form
  having those statistics as constraints, and vice versa}. See the end of
this section for detailed references about this theorem.
