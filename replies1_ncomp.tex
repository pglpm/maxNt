...
%% Last-Updated: 2020-03-16T16:48:19+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\textbullet\ If by \enquote{model} we mean only a family of probability
distribution, \eg\
...
than $M_{2}$, then it must also assign lower probability to each data point
in that volume, to ensure normalization. As a result, if the observed data
...
extensively explained by MacKay \citey{mackay1992}. And this is the reason
why we are personally satisfied with simply comparing the evidence for any
two models.
