...
%% Last-Updated: 2020-03-16T22:02:36+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
element therein, to ensure normalization. As a result, if the observed data
...
that the correction would nevertheless be the same in the calculations
based on the larger population, \eqns~(11), and on the sample, \eqns~(12).
Hence the difference in the two approaches -- our main message -- should
persist. But it would be better to check this.
...
high, and they are to be used in different ways.
