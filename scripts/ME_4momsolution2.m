...
Clear[MEhom4moments2,MEhom4thmoment,MEhomvmoments,MEhom4momentsprob]; 

MEhom4moments2[m1_, m2_, m3_, m4_, nn_, wp_:MachinePrecision] := 
 Block[{totalprob,
	...
	bvalues},
       zzzm = Sum[Binomial[nn, m]*
		  Exp[js1*m + js2*Binomial[m,2] +
		      js3*Binomial[m,3] +
		      js4*Binomial[m,4]],
       {m, 0, nn}];
  freeenm = Log[zzzm] - js1*m1*nn - js2*m2*nn2 -js3*m3*nn3 -js4*m4*nn4;
  soluzm = 
 ...
 {js1/nn /. soluzm[[2]], js2/nn2 /. soluzm[[2]],
